                    ...
                    <div class="card ">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Total | Cancelled Travel Order</p>
                                        <h3 class="font-weight-bolder mb-0 ">
                                            {{ $travelTotal }}
                                        </h3>
                                    </div>
                    ...
                    <div class="card ">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Approved Travel Order</p>
                                        <h3 class="font-weight-bolder mb-0 ">
                                            {{ $travelApproved }}
                                        </h3>
                                    </div>
