{{-- Modal Department --}}
<div wire:ignore.self class="modal fade" role="dialog" id="addItemModal" tabindex="-1"
    aria-labelledby="addDepartmentModalLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog">
        <form wire:submit.prevent="saveItem">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addDepartmentModalLabel">Add Item</h1>
                </div>
...
<div wire:ignore.self class="modal fade" role="dialog" id="deleteItemModal" tabindex="-1"
    ...
    <div class="modal-dialog ">
        <form wire:submit.prevent="destroyItem">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6 class="text-danger">Are you sure you want to delete this item?</h6>
                </div>
                <div class="modal-footer">
