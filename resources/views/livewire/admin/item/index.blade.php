<div class="col-xl-12 col-sm-6 mb-xl-0 mb-4">
    ...
    <div class="card">
        @include('livewire.admin.item.modal')
        <div class="card-body p-3">
            <h4 class="card-title">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="m-0 font-weight-bold text-muted">ITEM MANAGEMENT</h5>
